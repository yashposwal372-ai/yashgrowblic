  ...
  return (
    <div className="product-window">
      <div className="product-window__bar">
        ...
        <span className="product-window__mode">Concept interface</span>
      </div>
      {children}
    </div>
  );
    ...
    <Shell label="AI Desk">
      <div className="desk-ui">
        ...
        <aside className="desk-context">
          ...
          <dl><div><dt>Status</dt><dd>Active</dd></div><div><dt>Last activity</dt><dd>12 min ago</dd></div><div><dt>Routing</dt><dd>General queue</dd></div></dl>
        </aside>
      </div>
    </Shell>
  );
    ...
    <Shell label="Learn">
      <div className="dashboard-ui">
        ...
        <div className="dashboard-main">
          ...
          <div className="learn-stats"><article><span>Active courses</span><strong>04</strong><small>Sample value</small></article><article><span>Overall progress</span><strong>72%</strong><div className="progress-track"><i style={{ "--progress": "72%" } as React.CSSProperties} /></div></article><article><span>Upcoming</span><strong>2</strong><small>Assessments</small></article></div>
          <div className="dashboard-grid"><article className="course-card"><span className="course-card__icon"><Box size={18} /></span><div><small>Current module</small><strong>Product foundations</strong><span>6 of 8 lessons</span></div><div className="progress-track"><i style={{ "--progress": "76%" } as React.CSSProperties} /></div></article><article className="activity-card"><span className="mock-kicker">Recent activity</span><p><Check size={13} /> Interface systems <span>Complete</span></p><p><Clock3 size={13} /> Applied automation <span>18 min</span></p></article></div>
        </div>
      </div>
    </Shell>
  );
    ...
    <Shell label="Commerce">
      <div className="dashboard-ui">
        ...
        <div className="dashboard-main">
          ...
          <div className="commerce-stats"><article><span>Sample orders</span><strong>284</strong><small>+12.4% demo trend</small></article><article><span>Products</span><strong>96</strong><small>8 low stock</small></article><article><span>Customers</span><strong>1.2k</strong><small>Interface sample</small></article></div>
  ...
  return (
    <Shell label="Secure">
      <div className="secure-ui">
        ...
        <div className="secure-stats"><article><Activity size={16} /><span>Auth events</span><strong>128</strong><small>Sample / 24h</small></article><article><LockKeyhole size={16} /><span>Active sessions</span><strong>14</strong><small>Demo accounts</small></article><article><Bell size={16} /><span>Review queue</span><strong>03</strong><small>Needs attention</small></article></div>
