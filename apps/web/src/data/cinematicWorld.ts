...
export const cinematicChapters: CinematicChapter[] = [
  { id: "home", index: "01", title: "Home", label: "Growblic HQ", description: "The connected starting point for every Growblic digital system.", range: [0,.1], position: [0,0,0], camera: [10,11,16] },
  { id: "services", index: "02", title: "Services", label: "Services Boulevard", description: "Eight specialist facilities connected around real business workflows.", range: [.1,.24], position: [0,0,-42], camera: [10,11,-26], routeColor: "#D84B52", route: [[-.7,.3,1],[-.7,.3,-1],[1.7,.3,-1],[1.7,.3,-3.3],[4.1,.3,-3.3],[4.1,.3,-10],[4,.3,-15],[-3,.3,-15],[-3,.3,-27],[2,.3,-27],[0,.3,-42]] },
  { id: "products", index: "03", title: "Products", label: "Product Labs", description: "Concept platforms where AI, automation, learning, commerce and security take shape.", range: [.24,.45], position: [38,0,-74], camera: [48,11,-58], routeColor: "#FF6368", route: [[0,.3,-42],[8,.3,-48],[18,.3,-48],[18,.3,-60],[29,.3,-60],[29,.3,-70],[38,.3,-74]] },
...
export function getArrivedCinematicChapter(progress: number) {
  ...
  return local >= .94 ? chapterIndex : chapterIndex - 1;
}
